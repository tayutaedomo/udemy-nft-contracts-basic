...
// Chainlink サンプルコード(※1)に対して、以下２点の変更を行った。
...
//
// Section 14 のために以下サンプルコードををコピー。
// Ref: https://github.com/toto-1010/nft-smart-contracts-basic1/blob/main/contracts/lecture-codes/Section13/ChainlinkVRFDemo.sol
